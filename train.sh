...
python $path_to_opennmt/train.py -gpuid 0 -epochs 20 -data $path_to_data/processed -save_model $path_to_data/model -layers 1 -word_vec_size 300 -share_embeddings -rnn_size 300 -copy_attn -copy_attn_force
